...
<template>
  <div class="space-y-8">
    <header class="text-center lg:text-left">
      <h1 class="text-3xl font-semibold tracking-tight mb-2">Inicia sesión</h1>
      <p class="text-[var(--color-on-surface-variant)]">Accede a tu panel y gestiona tu negocio.</p>
    </header>
    ...
    <form class="space-y-5" @submit.prevent="handleSubmit">
      ...
      <div class="space-y-2">
        ...
        <div class="text-right">
          <NuxtLink to="/forgot-password" class="text-xs text-[var(--color-primary)] hover:underline">
    ...
    <p class="text-center text-sm text-[var(--color-on-surface-variant)]">
      ¿No tienes cuenta?
      <NuxtLink to="/register" class="text-[var(--color-primary)] font-bold hover:underline">
        Regístrate gratis
      </NuxtLink>
    </p>
  </div>
